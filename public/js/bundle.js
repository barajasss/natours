...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYmFyYWphc3dhcmdpYXJ5IiwiYSI6ImNrYjB1ZG11bTBicHAyc210bzlxZHY0c2MifQ.RuoZ7N6zGiwMuOeNeFVa9A';
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            (0, _alerts.showAlert)('error', 'Erorr logging out! Try again!');
...
var stripe = Stripe('pk_test_51GrOkUJ1kommwwumwKP1VBRdEe1Omlg01ako941QISbm0R4nBcCio8skVXdocLct8wouz1DyVeJlRAsicnJTkPJs00AQWGdDSe');
...
if (mapBox) {
  var locations = JSON.parse(document.querySelector('[data-locations]').dataset.locations);
