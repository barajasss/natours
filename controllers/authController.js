...
exports.protect = catchAsync(async (req, res, next) => {
    ...
    if (currentUser.changedPasswordAfter.call(currentUser, decoded.iat)) {
        return next(
            new AppError(
...
exports.updatePassword = catchAsync(async (req, res, next) => {
    ...
    if (!oldPassword || !password || !passwordConfirm) {
        return next(
            new AppError(
                'There must be fields oldPassword, password and passwordConfirm in the post body request',
                400
            )
        );
    }
